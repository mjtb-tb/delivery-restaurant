        ...
        <Link to={`./${id}`} className="box">
            ...
            <div className="box-bottom">
                <div className="box-bottom-foodName">
                    <span className='box-bottom-foodName-titleText'>name:</span>
                    <span className='box-bottom-foodName-nameText'>{name}</span>
                </div>
                <div className="box-bottom-price">
                    <span className='box-bottom-price-titleText'>price:</span>
                    <span className='box-bottom-price-priceText'>{price}$</span>
                </div>
            </div>
        </Link>
    </>
